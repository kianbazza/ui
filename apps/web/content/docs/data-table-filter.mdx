...
> [!NOTE] If you use controlled state and wish to specify a default value, use the mechanism provided by your state management solution. The `defaultFilters` property is useless in this case.
