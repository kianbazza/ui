...
import { preFlightAdd } from '@/src/preflights/preflight-add.js'
import { getRegistryIndex, getRegistryItem, isUrl } from '@/src/registry/api.js'
import type { registryItemTypeSchema } from '@/src/registry/schema.js'
import { addComponents } from '@/src/utils/add-components.js'
import * as ERRORS from '@/src/utils/errors.js'
import { getProjectInfo } from '@/src/utils/get-project-info.js'
