...
import { getRegistryIcons } from '@/src/registry/api.js'
import type { iconsSchema } from '@/src/registry/schema.js'
import type { Config } from '@/src/utils/get-config.js'
import { highlighter } from '@/src/utils/highlighter.js'
import { ICON_LIBRARIES } from '@/src/utils/icon-libraries.js'
